 ...
 * '/log/log_click_magazine_link' endpoint on the server for logging purposes
 * It includes a CSRF token in the request headers to protect against cross-site
...
function log_click(event) {
    ...
    fetch('/log/log_click_magazine_link', {
        method: 'POST',
        headers: {
