...
class TestModels:
    def test_Magazines(self):
        ...
        assert repr(magazine) == "Magazines(id=1,name=testName,magazine_link=testMagazineLink)"

    def test_MagazineYear(self):
        magazine_year = MagazineYear(id=1,magazine_id=1,year="testYear",magazine_year_link="testMagazineYearLink")
        ...
        assert repr(magazine_year) == "MagazineYear(id=1,magazine_id=1,year=testYear,magazine_year_link=testMagazineYearLink)"

    def test_MagazineNumber(self):
        magazine_number = MagazineNumber(id=1,magazine_year_id=2,magazine_number="testMagazineNumber",magazine_number_link="testMagazineNumberLink")
        ...
        assert repr(magazine_number) == "MagazineNumber(id=1,magazine_year_id=2,magazine_number=testMagazineNumber,magazine_number_link=testMagazineNumberLink)"

    def test_MagazineNumberContent(self):
        magazine_number_content = MagazineNumberContent(id=1,magazine_number_id=2,magazine_content="testContent",magazine_page="3")
        ...
        assert repr(magazine_number_content) == "MagazineNumberContent(id=1,magazine_number_id=2,magazine_content=testContent,magazine_page=3)"

    def test_MagazineNumberContentFTS(self):
        magazine_number_content_fts = MagazineNumberContentFTS(rowid=1,magazine_content="testMagazineContent")
