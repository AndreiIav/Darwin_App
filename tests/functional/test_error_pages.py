...
def test_no_results_found_in_search_page_due_to_incorrect_lenghth_of_input(test_client, incorrect_input):
    response = test_client.get("/results/search", query_string={"search_box": incorrect_input})
